...
sudo chmod +x /root/timeismoney-cli /root/timeismoneyd /root/timeismoney-tx
sudo mv /root/timeismoney-cli /root/timeismoneyd /root/timeismoney-tx /usr/local/bin
